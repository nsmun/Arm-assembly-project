 // Save state 1 - Only update button_count when light is on. 
  .syntax unified
  .cpu cortex-m4
  .fpu softvfp
  .thumb
...
EXTI0_IRQHandler:
  ...
  @ Check if LED is on by reading GPIOE_ODR and testing the LD3_PIN bit
  ...
  BEQ   SkipCount               @ If LED is off, skip counting
